...
public class AuthenticationProtocolServer extends AsyncService {
    ...
    private List<String> completedAuthentications = new ArrayList<String>();
    private Map<String, Service> acceptServices = new HashMap<String, Service>();
 ...
 */
    protected void onServiceRequest() throws java.io.IOException {
        ...
        Iterator<String> it = SshAuthenticationServerFactory.getSupportedMethods()
                                                    .iterator();
        String method;
 ...
 */
    ...
    private void sendUserAuthFailure(boolean success) throws IOException {
        Iterator<String> it = availableAuths.iterator();
        String auths = null;
                ...
                if (acceptServices.containsKey(msg.getServiceName())) {
                    ...
                    if (availableAuths.contains(method)) {
                        ...
                        if (result == AuthenticationProtocolState.FAILED) {
                            ...
                            Iterator<String> it = sc.getRequiredAuthentications()
                                            .iterator();
