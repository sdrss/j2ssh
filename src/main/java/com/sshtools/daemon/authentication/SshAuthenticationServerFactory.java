...
public class SshAuthenticationServerFactory {
    private static Map<String, Class<?>> auths = new HashMap<String, Class<?>>();
    ...
    static {
        ...
        try {
            if (ConfigurationLoader.isConfigurationAvailable(
                ...
                List<ExtensionAlgorithm> addons = config.getAuthenticationExtensions();
                Iterator<ExtensionAlgorithm> it = addons.iterator();
