...
public class StringUtil {
     ...
     * occurrences of the separator string. In contrary to method parts() the
     * separator is a one or many character sequence delimiter. That is, only
     * the exact sequence of the characters in separator identifies the end of a
     * substring. Subsequent occurrences of separator will be skipped. Therefore
    ...
    /**
     * Returns the given text split up into an array of strings, at the
     * occurrences of the separator string. In contrary to method allParts() the
     * separator is a one or many character sequence delimiter. That is, only
     * the exact sequence of the characters in separator identifies the end of a
     * substring. Subsequent occurrences of separator are not skipped. They are
     * added as empty strings to the result.
     * 
     * @param text
     *            The text to be split up
     * @param separator
    ...
    public String reverse(String str) {
        ...
        for (char ch = iterator.last(); ch != CharacterIterator.DONE; ch = iterator
                .previous()) {
            newStr[i] = ch;
            i++;
        }
     ...
     * @return
     */
    public Map<String, String> toMap(String str, String elementSeparator,
            String keyValueSeparator, Map<String, String> map) {
        ...
        result = ((map == null) ? new HashMap<String, String>() : map);
...
//    }
     ...
     * separator is a one or many character sequence delimiter. That is, only
     * the exact sequence of the characters in separator identifies the end of a
     * substring. Parameter all defines whether empty strings between
