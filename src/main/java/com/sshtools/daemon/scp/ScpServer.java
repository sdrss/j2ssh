...
public class ScpServer extends NativeProcessProvider implements Runnable {
     ...
     * 
     * @see
     * com.sshtools.daemon.platform.NativeProcessProvider#allocatePseudoTerminal
     ...
     * 
     * @see
     * com.sshtools.daemon.platform.NativeProcessProvider#createProcess(java
     ...
     * 
     * @see
     * com.sshtools.daemon.platform.NativeProcessProvider#getDefaultTerminalProvider
     * ()
     */
     ...
     * 
     * @see
     * com.sshtools.daemon.platform.NativeProcessProvider#getStderrInputStream()
     */
     ...
     * 
     * @see
     * com.sshtools.daemon.platform.NativeProcessProvider#supportsPseudoTerminal
     * (java.lang.String)
     */
	...
	try {
		...
		try {
		    ...
		    /*
		     * If this looks like a wildcard, then attempt a simple
		     * expansion. This only work for the base part of the file
		     * name at the moment
		     */
		    if (sp.hasWildcard()) {
