...
public class SessionChannelFactory implements ChannelFactory {
	 ...
	 * ConfigurationLoader.getServerConfiguration(); sessionChannelImpl =
	 * ConfigurationLoader.getServerConfiguration().getSessionChannelImpl();
	 */
    }

    /*
     * public List getChannelType() { List list = new ArrayList();
     * list.add(SessionChannelServer.SESSION_CHANNEL_TYPE); return list; }
     */
    ...
    /*
     * public void setSessionChannelImpl(Class sessionChannelImpl) throws
     * InvalidChannelException { try { Channel channel = (Channel)
     * sessionChannelImpl.newInstance(); if (!(channel instanceof
     * AbstractSessionChannelServer)) { throw new InvalidChannelException(
     * "Class does not extend AbstractSessionChannelServer"); } } catch
     * (Exception e) { throw new InvalidChannelException(
