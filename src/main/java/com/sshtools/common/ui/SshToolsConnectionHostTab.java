 ...
 */
public class SshToolsConnectionHostTab extends JPanel implements
        SshToolsConnectionTab {

    private static final long serialVersionUID = -4038219075730641346L;
    ...
    protected java.util.List<Object> methods = new ArrayList<Object>();
...
*/
    public void setConnectionProfile(SshToolsConnectionProfile profile) {
        ...
        final Map<String, SshAuthenticationClient> auths = (profile == null) ? new HashMap<String, SshAuthenticationClient>()
                : profile.getAuthenticationMethods();
        Iterator<Map.Entry<String, SshAuthenticationClient>> it = auths
                .entrySet().iterator();
        ...
        while (it.hasNext()) {
            final Map.Entry<String, SshAuthenticationClient> entry = it.next();
            final String authmethod = entry.getKey();
            ...
            /*
             * if (jListAuths.getNextMatch(authmethod, 0, Position.Bias.Forward)
             * > -1) { selectionarray[count] =
             * jListAuths.getNextMatch(authmethod, 0, Position.Bias.Forward);
             * count++; }
             */
...
*/
    ...
    private void addAuthenticationMethods() {
        java.util.List<Object> methods = new ArrayList<Object>();
...
*/
    public boolean validateTab() {
        ...
        java.util.List<Object> chosen = getChosenAuth();

        if (chosen != null) {
            Iterator<Object> it = chosen.iterator();
    ...
    private java.util.List<Object> getChosenAuth() {
        // Determine whether any authentication methods we selected
