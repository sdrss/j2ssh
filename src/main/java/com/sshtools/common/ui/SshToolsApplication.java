...
public abstract class SshToolsApplication {
    ...
    /**  */
    protected static List<SshToolsApplicationContainer> containers = new ArrayList<SshToolsApplicationContainer>();
    ...
    static {
        ...
        allLookAndFeelInfo[i.length + 1] = new UIManager.LookAndFeelInfo(
                "Cross Platform", CROSS_PLATFORM_LAF);
        allLookAndFeelInfo[i.length + 2] = new UIManager.LookAndFeelInfo(
                "System", SYSTEM_LAF);
    }
    ...
    protected java.util.List<OptionsTab> additionalOptionsTabs = new java.util.ArrayList<OptionsTab>();
...
*/
    public void exit() {
        ...
        if (a != null) {
            ...
            log
                    .debug("Not saving preferences because no preferences directory is available.");
        }
    ...
    public SshToolsApplicationContainer getContainerAt(int idx) {
        return (SshToolsApplicationContainer) containers.get(idx);
    }
    ...
    public SshToolsApplicationContainer getContainerForPanel(
        ...
        for (Iterator<SshToolsApplicationContainer> i = containers.iterator(); i.hasNext();) {
    ...
    public void closeContainer(SshToolsApplicationContainer container) {
        ...
        if (container.getApplicationPanel().canClose()) {
            ...
            if (containers.size() == 0) {
                ...
                log
                        .debug("Not closing completely because there are containers still open");
    ...
    public SshToolsApplicationContainer convertContainer(
        ...
        try {
            ...
            containers.add(idx, newContainer);
    ...
    public void init(String[] args) throws SshToolsApplicationException {
        ...
        try {
            ...
            UIManager.put("OptionPane.errorIcon", new ResourceIcon(
                    SshToolsApplication.class, "dialog-error4.png"));
            UIManager.put("OptionPane.informationIcon", new ResourceIcon(
                    SshToolsApplication.class, "dialog-information.png"));
            UIManager.put("OptionPane.warningIcon", new ResourceIcon(
                    SshToolsApplication.class, "dialog-warning2.png"));
            UIManager.put("OptionPane.questionIcon", new ResourceIcon(
                    SshToolsApplication.class, "dialog-question3.png"));
        } catch (Throwable t) {
            log.error(t);
        }
    }
    ...
    public static void setLookAndFeel(String className) throws Exception {
        ...
        if (!className.equals(DEFAULT_LAF)) {
            if (className.equals(SYSTEM_LAF)) {
                ...
                log
                        .debug("Cross Platform Look And Feel is "
                                + crossPlatformLaf);
                laf = (LookAndFeel) Class.forName(crossPlatformLaf)
                        .newInstance();
            } else {
        ...
        if (laf != null) {
            ...
            UIManager
                    .put("EditorPane.font", UIManager.getFont("TextArea.font"));
        }
    }
}
