...
public class ResourceIcon extends ImageIcon {
     ...
     *             software is plugable; each class requesting a resource should
     *             do so from the class loader that loaded the class, to keep
     *             track of images a class should also not be requesting a
     *             resource that is outside its own package.
     * 
     *             For resources outside of a package, we should think about
     *             creating static helper class to store them.
     * 
     *             Use the ResourceIcon(Class cls, String image) constructor
     *             instead providing the class instance of the class using the
     *             image.
     * 
     */
