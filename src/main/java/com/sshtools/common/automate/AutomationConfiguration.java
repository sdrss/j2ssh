...
public class AutomationConfiguration {
    private Map<String, RemoteIdentification> remoteIdentifications = new HashMap<String, RemoteIdentification>();
     ...
     * @return
     */
    public Map<String, RemoteIdentification> getRemoteIdentifications() {
	...
	public void startElement(String uri, String localName, String qname,
		...
		if (currentElement.equals(AUTOMATION_ELEMENT)) {
			...
			String defaultName = attrs
				.getValue(DEFAULTNAME_ATTRIBUTE);
			...
			String startsWith = attrs
				.getValue(STARTSWITH_ATTRIBUTE);
			...
			String implementationClass = attrs
				.getValue(IMPLEMENTATION_ATTRIBUTE);
			String defaultPath = attrs
				.getValue(DEFAULTPATH_ATTRIBUTE);
			...
			try {
			    currentRID.setAuthorizedKeysFormat(Class
				    .forName(implementationClass));
			    currentRID
				    .setAuthorizedKeysDefaultPath(defaultPath);
