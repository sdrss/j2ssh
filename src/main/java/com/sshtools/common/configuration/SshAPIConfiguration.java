 ...
 */
public class SshAPIConfiguration extends DefaultHandler implements
    ...
    private List<ExtensionAlgorithm> currentList = null;
     ...
     * @throws IOException
     */
    public SshAPIConfiguration(InputStream in) throws SAXException,
    ...
    public void startElement(String uri, String localName, String qname,
        ...
        if (currentElement == null) {
            ...
            } else if ((currentElement.equals("ExtensionAlgorithm") && qname
                    .equals("AlgorithmName"))
                    || (currentElement.equals("ExtensionAlgorithm") && qname
    ...
    public String toString() {
        ...
        for(ExtensionAlgorithm ext : cipherExtensions) {
        ...
        for(ExtensionAlgorithm ext : macExtensions) {
            xml += "      <ExtensionAlgorithm>\n";
            xml += ("         <AlgorithmName>" + ext.getAlgorithmName() + "</AlgorithmName>\n");
            xml += ("         <ImplementationClass>"
                    + ext.getImplementationClass() + "</ImplementationClass>\n");
        ...
        for(ExtensionAlgorithm ext : compressionExtensions) {
            xml += "      <ExtensionAlgorithm>\n";
            xml += ("         <AlgorithmName>" + ext.getAlgorithmName() + "</AlgorithmName>\n");
            xml += ("         <ImplementationClass>"
                    + ext.getImplementationClass() + "</ImplementationClass>\n");
        ...
        for(ExtensionAlgorithm ext : pkExtensions) {
            xml += "      <ExtensionAlgorithm>\n";
            xml += ("         <AlgorithmName>" + ext.getAlgorithmName() + "</AlgorithmName>\n");
            xml += ("         <ImplementationClass>"
                    + ext.getImplementationClass() + "</ImplementationClass>\n");
        ...
        for(String cls : pkFormats) {
            xml += ("      <PublicKeyFormat ImplementationClass=\"" + cls + "\"/>\n");
        }

        for(String cls : prvFormats) {
        ...
        for(ExtensionAlgorithm ext : kexExtensions) {
            xml += "      <ExtensionAlgorithm>\n";
            xml += ("         <AlgorithmName>" + ext.getAlgorithmName() + "</AlgorithmName>\n");
            xml += ("         <ImplementationClass>"
                    + ext.getImplementationClass() + "</ImplementationClass>\n");
        ...
        for(ExtensionAlgorithm ext : authExtensions) {
            xml += "      <ExtensionAlgorithm>\n";
            xml += ("         <AlgorithmName>" + ext.getAlgorithmName() + "</AlgorithmName>\n");
            xml += ("         <ImplementationClass>"
                    + ext.getImplementationClass() + "</ImplementationClass>\n");
