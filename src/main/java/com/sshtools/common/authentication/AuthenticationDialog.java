...
public class AuthenticationDialog extends JDialog {
    private static final long serialVersionUID = 6470622706387124224L;
     ...
     * @return
     */
    public static java.util.List<Object> showAuthenticationDialog(Component parent,
            java.util.List<String> support) {
     ...
     */
    public static java.util.List<Object> showAuthenticationDialog(Component parent,
            java.util.List<String> support, String message) {
     ...
     * @return
     */
    public java.util.List<Object> showAuthenticationMethods(java.util.List<String> supported,
            String message) {
        // Set the list
