...
implements TransportProtocol, Runnable 
{
    ...
    private List<TransportProtocolEventHandler> eventHandlers = new ArrayList<TransportProtocolEventHandler>();
    ...
    private Map<Integer, SshMessageStore> messageNotifications = new HashMap<Integer, SshMessageStore>();
...
//    private Object keyLock = new Object();
    ...
    private List<SshMessageStore> messageStores = new ArrayList<SshMessageStore>();
    ...
    protected void beginKeyExchange() throws IOException, KeyExchangeException {
        ...
        // implementations take over so call abstract methods
        try {
            ...
            // Get an instance of the key exchange algorithm
    ...
    protected void sendNewKeys() throws IOException {
        ...
        // Lock the outgoing algorithms so nothing else is sent until
        // we've updated them with the new keys
        algorithmsOut.lock();
    ...
    protected void completeKeyExchange() throws IOException {
        ...
        try {
            ...
            synchronized (messageStack) {
                ...
                for(SshMessage msg : messageStack) {
                    sendMessage(msg, this);
                }
                messageStack.clear();
            }
    ...
    protected String determineAlgorithm(List<String> clientAlgorithms,
        List<String> serverAlgorithms) throws AlgorithmNotAgreedException {
        if (log.isDebugEnabled()) {
